...
/*
http://127.0.0.1:6001/checkpassword?opercode=sa
*/
import (
	"encoding/json"
	"fmt"
...
func JsonHandler(w http.ResponseWriter, r *http.Request) {
	...
	db, err := gorm.Open("mssql", "sqlserver://"+viper.GetString("his.userid")+":"+
		viper.GetString("his.password")+"@"+viper.GetString("his.ip")+":"+
		viper.GetString("his.sqlport")+"?database="+viper.GetString("his.database")+";encrypt=disable;app name=pda_server")
	if err != nil {
